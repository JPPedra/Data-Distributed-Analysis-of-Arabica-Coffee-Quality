...
#head(coffee_new_1%>% 
  ...
  #ggplot(aes(x = n, y = reorder(coffee_new_1$Country.of.Origin, Processing.Method))) + geom_bar(stat = "identity", fill = "#0072B2") + labs(x = "Coffee Produced", y = "Country of Origin") + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank(), axis.line = element_line(colour = "pink"))
```
