...
This variable represents an overall quality score for coffee and is the target variable of the regression model. Meaning, it is an important variable to answer the reserach question identified previously in this project.
...
The histogram output above represented show two possible outliers - for variables Aroma, Acidity and Body.
To better understand this outliers, it is necessary to use the boxplot and minimum functions below presented.

Therefore, the output does not present any outlier.
...
head(coffee_new_1%>%
  ...
  labs(x = "Coffee Produced", y = "Country of Origin") + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
...
Moreover, variables like Acidity, Aroma and flavor range according personal taste of the person drinking the coffee. Therefore, these variables should not be included in the regression model as they would disrupt the accuracy of the results. 
