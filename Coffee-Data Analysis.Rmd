...
This to understand the relationship between the numerical variables.

```{r}
plot(Aroma, Flavor,  data = coffee_new_1, colour = Total.Cup.Points)
...
ADD EXPLANATION OF THE PLOTS ABOVE
